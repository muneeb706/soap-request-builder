...
class StartTransactionRequestBuilder(SoapRequestBuilder):
    ...
    START_TRANSACTION_REQUEST_ATTRIBUTES_MAPPINGS = {
        ...
        ComplianceAttributes.DRIVERS_LICENSE_ADDRESS_TYPE.value:
            StartTransactionRequestXmlTagsNames.DRIVERS_LICENSE_ADDRESS_TYPE.value
    }
    ...
    def __init__(self, json_request_body, input_language):
        super().__init__(json_request_body, input_language, __class__.START_TRANSACTION_REQUEST_ATTRIBUTES_MAPPINGS,
    ...
    def _create_body_element(self):
        ...
        processing_options = ElementTree.SubElement(initial_request, 'v3:ProcessingOptions')
        ElementTree.SubElement(processing_options, 'v3:Language').text = self._processing_language
